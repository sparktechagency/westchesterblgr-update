...
class CreatorAllChatScreen extends StatelessWidget {
  CreatorAllChatScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<CreatorAllChatController>(
            init: CreatorAllChatController(),
            builder: (controller) {
              return Column(
                children: [
                                ...
                                children: [
                                  Material(
                                    ...
                                    child: IconButton(
                                      onPressed: () {
                                        controller
                                            .toggleExpanded(); // Toggle the expanded state
                                      },
                  ...
                  ...List.generate(
                    ...
                    (index) {
                      return InkWell(
                        onTap: () {
                          Get.toNamed(AppRoutes.creatorChatScreen);
                        },
