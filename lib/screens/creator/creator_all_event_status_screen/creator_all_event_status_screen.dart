...
import 'controllers/create_all_event_status_controller.dart';

class CreatorAllEventStatusScreen extends StatelessWidget {
  const CreatorAllEventStatusScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<CreatorAllEventStatusController>(
          init: CreatorAllEventStatusController(),
          builder: (controller) {
            return SingleChildScrollView(
              child: Column(
                children: [
                  const SpaceWidget(spaceHeight: 10),
                  ...controller.eventStatusList.map(
                    (event) {
