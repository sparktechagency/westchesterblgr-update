...
class CreatorDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<CreatorDashboardController>(
          init: CreatorDashboardController(),
          builder: (controller) {
                            ...
                            children: [
                              Expanded(
                                  ...
                                  child: _buildStatItem('Total Earning',
                                      '\$${controller.totalEarnings / 100}')),
                              const SpaceWidget(spaceWidth: 2),
                              _buildDivider(context),
                              const SpaceWidget(spaceWidth: 2),
                              Expanded(
                                  flex: 1,
                                  child: _buildStatItem('Total Views',
                              ...
                              Expanded(
                                  ...
                                  child: _buildStatItem(
                                      'Tickets Sold', controller.ticketType)),
                            ],
                          ),
                        ),
                      ],
