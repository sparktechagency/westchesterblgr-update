...
class SellItemSearchWidget extends StatefulWidget {
  ...
  @override
  State<SellItemSearchWidget> createState() => _SellItemSearchWidgetState();
}

class _SellItemSearchWidgetState extends State<SellItemSearchWidget> {
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: GestureDetector(
            onTap: widget.onSuffixIconTap, // Handle the tap event
            child: Padding(
