...
class UserSearchScreen extends StatelessWidget {
  ...
  Future<void> _refreshData() async {
    // Trigger refresh for all data sources concurrently
    await Future.wait([
            ...
            children: [
                      ...
                      child: Row(
                        children: [
                          ...List.generate(jobController.jobs.length, (index) {
                            ...
                            return Container(
                              width: ResponsiveUtils.width(320),
              ...
              Obx(() {
                if (controller.isLoading.value) {
                  ...
                  final limitedProducts = controller.products.length > 5
                      ? controller.products.sublist(0, 5)
                      : controller.products;
                  return Column(
                    children: [
                      ...List.generate(limitedProducts.length, (index) {
